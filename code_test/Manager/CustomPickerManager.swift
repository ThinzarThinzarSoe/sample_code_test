...
@objc open class CustomPicker: NSObject {
    
    private static let sharedInstance = CustomPicker()
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          dataArray:Array<String> = [],
                          selectedIndex: Int? = nil,
                          type: CustomPickerType = .date,
                          style: RDatePickerStyle = .Wheel) -> RPickerController? {
        
        
        if let cc = UIWindow.currentController {
            if CustomPicker.sharedInstance.isPresented == false {
                CustomPicker.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    CustomPicker.sharedInstance.isPresented = false
                }
...
class RPickerController: UIViewController {
    ...
    var pickerType: CustomPickerType = .date
    var dataArray: Array<String> = []
    
    //MARK:- Private variables
    private let barViewHeight: CGFloat = UIScreen.main.bounds.height * 0.06
    ...
    private func setUpThemeMode() {
        ...
        transView.backgroundColor = UIColor(white: 0.1, alpha: 0)
        if pickerType == .date {
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.font = UIFont.Roboto.Bold.font(size: 14)
    ...
    private lazy var doneButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont.Roboto.Bold.font(size: 14)
...
extension RPickerController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if (pickerLabel == nil) {
            pickerLabel = UILabel()
            pickerLabel?.font = UIFont.Roboto.Regular.font(size: 14)
